...
export default function Story(props) {
    ...
    return (
        <div className="story">
            ...
            {props.char3.name && <p>{props.char3.name} is a {props.char3.occupation} and wants to {props.char3.desire}.</p>}
            {props.char4.name && <p>{props.char4.name} is a {props.char4.occupation} and wants to {props.char4.desire}.</p>}
